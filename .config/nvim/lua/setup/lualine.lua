...
local function createDiffString()
  ...
  if added > 0 then
    output = output
      .. string.format("%%#lualine_b_diff_added_normal#+%d", added)
  end

  if removed > 0 then
    output = output
      .. string.format("%%#lualine_b_diff_removed_normal#-%d", removed)
  end

  if changed > 0 then
    output = output
      .. string.format("%%#lualine_b_diff_modified_normal#~%d", changed)
  end
